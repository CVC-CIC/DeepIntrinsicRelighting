...
class TrainOptions(BaseOptions):
    def __init__(self, which_experiment):
        ...
        # Setting for dataset
        self.anno = 'data/anno_ISR/train.txt'  # the anno file from prepare_dataset.py
        self.anno_validation = 'data/anno_ISR/val_pairs.txt'
        # Setting for GPU
        ...
        self.flag_ref_consistency = False
        self.loss_weight_ref_consistency = 1.0
        self.flag_sha_consistency = False
        ...
        self.flag_sha_ref_regression = False
