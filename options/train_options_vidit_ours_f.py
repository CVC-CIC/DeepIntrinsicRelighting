...
class TrainOptions(BaseOptions):
    def __init__(self, which_experiment):
        ...
        self.dataset_assignment_type = "AnyLight"
        self.anno = 'data/anno_VIDIT/any2any/train.txt'  # the anno file from prepare_dataset.py
        self.anno_validation = 'data/anno_VIDIT/any2any/AnyLight_val_pairs.txt'
        # Setting for GPU
        ...
        # data augmentation
        self.preprocess = 'resize'   # 'resize_and_crop'   # scaling and cropping of images at load time
        ...
        self.save_epoch_freq = 150  # frequency of saving checkpoints at the end of epochs
