...
class TestQuantitiveOptions(BaseOptions):
    def __init__(self):
        ...
        if using_dataset == "isr":
            ...
            self.anno = 'data/anno_ISR/test_quantitative_pairs_10x.txt'  # the anno file from prepare_dataset.py
            ...
            self.anno = 'data/anno_RSR/AnyLighttest_pairs.txt'  # the anno file from prepare_dataset.py
            self.preprocess = 'none'  # 'resize_and_crop'
            self.show_gt_intrinsic = False
            self.light_type = "pan_tilt_color"
        elif using_dataset == "vidit":
            self.dataset_mode = 'relighting_single_image_vidit'  # name of the dataset
            self.anno = 'data/anno_VIDIT/any2any/AnyLight_test_pairs.txt'  # for table any-to-any
            ...
            self.anno = 'data/multi_illumination/test.txt'
        ...
        # self.img_size = (resolution, resolution)
        # self.preprocess = 'resize'
        # self.load_size = resolution  # scale images to this size
        # self.crop_size = resolution  # then crop to this size
